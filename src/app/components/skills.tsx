  ...
  return (
    <section className='flex flex-col items-center w-full h-full'>
      <div className='flex flex-col items-center justify-center mt-16'>
        ...
        <p className='text-gray-500 uppercase text-sm sm:text-base mt-2'>Constant learning, new tech every time!</p>
      </div>
      ...
      <main className='mt-8 mb-16 pt-8 px-8 pb-6 flex flex-col md:flex-row items-center gap-4 h-full w-full rounded-md shadow-[0_35px_60px_-15px_rgba(0,6,5,0.3)]'>
        ...
        <div className={`w-full md:w-1/2 flex items-center ${!activeCard ? 'hidden' : ''}`}>
        ...
        <ul className='w-full md:w-1/2 flex flex-col gap-0'>
          <li
            ...
            className='justify-center hover:bg-black p-4 hover:text-white flex flex-col items-center'
          >
